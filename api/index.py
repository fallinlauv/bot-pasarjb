...
async def handle_user_message(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    keyboard = InlineKeyboardMarkup([[InlineKeyboardButton("✏️ Edit Request", callback_data="open_request")], [InlineKeyboardButton("📤 Post to Channel", callback_data="post_request")]])
...
def main():
    if request.method == 'POST':
        ...
        # Trik: Jalankan pemrosesan di background agar Flask bisa langsung balas 'OK'
        async def process():
        ...
        return 'OK', 200 # Balasan instan ke Telegram
